                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">请输入您要增加的的课程信息</div>
                                    </div>
                                </div>
                    <div class="card-body">
                     <form action="<%=basePath%>courseadmin/courseadd" method="post">                   
                                  <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入增加的课程名称"name="name">
