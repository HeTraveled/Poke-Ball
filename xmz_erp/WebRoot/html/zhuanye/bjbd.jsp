                ...
                <div class="side-body">
                    ...
                    <div class="row">
                        ...
                        <div class="panel fresh-color panel-info">
                                                <div class="panel-heading">班级修改</div>
                                      ...
                                      <!--   <tfoot>
                                        ...
                                        <tbody>
                                         <c:forEach var="n" items="${name}">
                                           ...
                                           <!--  <tr>
                                                <td><a class="xmz_a" title="点击查看详细信息">马化腾</a></td>
                                                <td><div class="checkbox3 checkbox-success checkbox-inline checkbox-check checkbox-round  checkbox-light">
                                            ...
                                            <tr>
                                                <td><a class="xmz_a" title="点击查看详细信息">马云</a></td>
                                                <td><div class="checkbox3 checkbox-success checkbox-inline checkbox-check checkbox-round  checkbox-light">
